...
class PilotsPlaceholder extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const ModulePlaceholder(title: 'Pilot Management');
}

class OperationsPlaceholder extends StatelessWidget {
  const OperationsPlaceholder({super.key});
  @override
  Widget build(BuildContext context) => const ModulePlaceholder(title: 'Operations Management');
}
...
class DronesPlaceholder extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const ModulePlaceholder(title: 'Drone Management');
}

class ReportsPlaceholder extends StatelessWidget {
  const ReportsPlaceholder({super.key});
  @override
  Widget build(BuildContext context) => const ModulePlaceholder(title: 'Reports & Analytics');
}

class SettingsPlaceholder extends StatelessWidget {
  const SettingsPlaceholder({super.key});
  @override
  Widget build(BuildContext context) => const ModulePlaceholder(title: 'Admin Settings');
}
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(user?.name ?? 'Admin Name', style: AppTextStyles.titleLarge),
            Text(user?.email ?? 'admin@lakshya.com', style: AppTextStyles.bodyMedium),
