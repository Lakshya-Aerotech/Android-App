            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  // Width per card = (Total Width - crossAxisSpacing) / 2
                  final double width = constraints.maxWidth;
                  final double itemWidth = (width - 16) / 2;
                  
                  // contentHeight: icon(36) + spacer + value(22) + gap(2) + title(12) + padding(24)
                  // We increase min height to 135 to ensure zero overflow and visible text.
